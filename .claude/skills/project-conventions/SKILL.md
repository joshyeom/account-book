...
description: AI 가계부 프로젝트의 코딩 컨벤션 가이드라인. 코드 작성, 리뷰, 리팩토링 시 일관된 스타일을 보장하기 위해 사용. 새 파일 생성, 함수 작성, 타입 정의, 커밋 작성 시 트리거됨.
---

# 프로젝트 코딩 컨벤션

AI 가계부 프로젝트의 코드 스타일 및 컨벤션 가이드. 일관성 있고 유지보수하기 쉬운 코드 작성을 위한 규칙들.
...
| 백엔드     | API Routes, Supabase, 서버 컴포넌트 | `backend-`  |
...
- `BACKEND.md` - 백엔드 코딩 컨벤션 (API Routes, Supabase, 서버 컴포넌트)

## 전체 컴파일된 문서

- `AGENTS.md` - 모든 프론트엔드 규칙이 확장된 전체 가이드
- `BACKEND.md` - 백엔드 규칙 (주니어 프론트엔드 엔지니어용)
